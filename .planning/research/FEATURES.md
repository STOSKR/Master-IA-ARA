...
1. Raw sample inspection workflow per source.
1. Async multi-source extractors producing unified historical tables.
1. Retry/backoff, dumps, and minimal observability.
1. Basic schema/quality gates.
